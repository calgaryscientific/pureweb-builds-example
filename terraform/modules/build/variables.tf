...
variable "image_pull_credentials_type" {
  ...
  description = "Set the type of credentials needed to pull the build image"
}

variable "branch_hook" {
  type        = string
  default     = "master"
  description = "Set the default branch that the webhook should be watching for changes"
}
